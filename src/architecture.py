...
def build_discriminator(input_, reuse=False):
    with tf.variable_scope("Discriminator", reuse=reuse):
        x = tf.layers.conv1d(input_, filters=8, kernel_size=9, padding="same", strides=1, activation=leaky_relu,
                             kernel_initializer=tf.contrib.layers.xavier_initializer(), name="conv1d_1_1")

        x = tf.layers.conv1d(x, filters=8, kernel_size=9, padding="same", strides=1, activation=leaky_relu,
        ...
        x = tf.layers.conv1d(x, filters=16, kernel_size=9, padding="same", strides=1, activation=leaky_relu,
        ...
        x = tf.layers.conv1d(x, filters=32, kernel_size=9, padding="same", strides=1, activation=leaky_relu,
