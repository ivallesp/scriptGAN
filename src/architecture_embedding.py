...
def build_discriminator(input_, reuse=False):
    with tf.variable_scope("Discriminator", reuse=reuse):
        x = tf.layers.conv1d(input_, filters=256, kernel_size=15, padding="same", strides=1, activation=leaky_relu,
                             kernel_initializer=tf.contrib.layers.xavier_initializer(), name="conv1d_1_1")

        x = tf.layers.conv1d(x, filters=256, kernel_size=15, padding="same", strides=1, activation=leaky_relu,
        ...
        x = tf.layers.conv1d(x, filters=512, kernel_size=15, padding="same", strides=1, activation=leaky_relu,
        ...
        x = tf.layers.conv1d(x, filters=1024, kernel_size=15, padding="same", strides=1, activation=leaky_relu,
        ...
        x = tf.layers.conv1d(x, filters=2048, kernel_size=15, padding="same", strides=1, activation=leaky_relu,
...
def build_generator(z, max_length, batch_size, vocabulary_size):
    with tf.variable_scope("Generator", reuse=False):
        ...
        z_norm = bn_z(z)
        zh_projected = tf.layers.dense(z_norm, 4096, activation=None, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="dense_zh_projection")
        zc_projected = tf.layers.dense(z_norm, 4096, activation=None, kernel_initializer=tf.contrib.layers.xavier_initializer(), name="dense_zc_projection")
